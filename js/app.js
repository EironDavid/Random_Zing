(function () {
  ...
  const iconPlayMini = btnPlayMini.querySelector('.icon-play');
  const iconPauseMini = btnPlayMini.querySelector('.icon-pause');
  ...
  function togglePlayerExpanded() {
    ...
    playerBody.setAttribute('aria-hidden', !playerExpanded);
  }
  ...
  function updatePlayButton() {
    ...
    iconPlayMini.classList.toggle('hidden', playing);
    iconPauseMini.classList.toggle('hidden', !playing);
  ...
  btnAsk.addEventListener('click', () => goToScreen(4, 'forward'));
